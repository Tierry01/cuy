...
<body>
  ...
  <div class="top-head">
    ...
    <aside>
        ...
        <a href="/share/page/cuy-gec" class="aside-element active"><div><i class="fas fa-inbox"></i> Boîte de réception</div> <span>3433</span></a>
        ...
        <a href="/share/page/gec-OutBount" class="aside-element"><div><i class="fas fa-envelope"></i> Nouveau courrier sortant</div></a>
        ...
        <a href="#" class="aside-element"><div><i class="fas fa-sticky-note"></i> Courriers Enregistrés</div></a>
           ...
           <div class="table-containt">
            <table id="dtBasicExample" class="table table-sm" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th class="th-sm">Objet <br> <span></span>
                    </th>
                    <th class="th-sm">Ref courrier <br> <span></span>
                    </th>
                    <th class="th-sm">
                        Ref expéditeur <br> <span></span>                  
                    </th>
                    <th class="th-sm">Date de réception <br> <span></span>
                    </th>
                    <th class="th-sm">
                        Actions 
                    </th>
