...
<body>
  ...
  <div class="top-head">
    ...
    <aside>
        ...
        <a href="/share/page/gec-arrive" class="aside-element"><div><i class="fas fa-envelope-square"></i> Nouveau courrier entrant</div></a>
        <a href="/share/page/gec-OutBount" class="aside-element active"><div><i class="fas fa-envelope"></i> Nouveau courrier sortant</div></a>
    ...
    <div class="container">
           <h5>Nouveau courrier sortant</h5>
            <div class="block">
              <div class="flex">
                <form class="js-formcourrier" action="">
                  <Label for="courrier" class="file"><i class="fas fa-upload"></i> Courrier</Label>
                  <input type="file" class="inputfile cour" name="courrier" id="courrier">
                  <Label for="piece" class="file"><i class="fas fa-upload"></i> Document Joint</Label>
                  ...
                  <div class="blck">
                    <label for="nature">Nature du courrier</label>
                    <select id="nature">
                        <option value="" selected disabled class="defo">--S'il vous plait veillez choisir la nature--</option>
                        <option value="confidentiel">Confidentiel</option>
                        <option value="ordinaire">Ordinaire</option>
                        <option value="urgent">Urgent</option>
                        <option value="tres">Très Urgent</option>
                    </select>
                  </div>
                  <div class="blck">
                  ...
                  <div class="blck">
                    <label for="">date de d'envoie</label>
                    <input class="input" type="text">
                  </div>
                  <div class="blck">
		  ...
		  <button type="submit">Envoyer</button>
                ...
                <div class="previsualisation">
                    <div class="head">
                        <div class="head-item one" cible="one">Courrier Principal</div>
